<%@ WebHandler Language="C#" Class="YGPJGZ" %>
...
public class YGPJGZ : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            string JSSqlWhere = " 1=1 ";
            string GZSqlWhere = " 1=1 ";
            //string GetType = Request["GetType"];
            string startdd = Request["startdd"];
            string enddd = Request["enddd"];

            if (!string.IsNullOrEmpty(startdd))
            {
                JSSqlWhere += " and js_dd >='" + startdd +"'";
                GZSqlWhere += " and A.jx_dd >='" + startdd + "'";
            }

            if (!string.IsNullOrEmpty(enddd))
            {
                JSSqlWhere += " and js_dd <='" + enddd + "'";
                GZSqlWhere += " and A.jx_dd <='" + enddd + "'";
            }
            ...
            if (depFindSub.ToLower() == "true" && !string.IsNullOrEmpty(user_dep_no))
            {
                ...
                if (!string.IsNullOrEmpty(dwRoad))
                {
                    ...
                    JSSqlWhere += " and dep_no in (" + dwRoad + ")";
                    GZSqlWhere += " and P.dep_no in (" + dwRoad + ")";
                ...
                else
                {
                    ...
                    {
                        JSSqlWhere += " and dep_no in ('" + user_dep_no + "')";
                        GZSqlWhere += " and P.dep_no in ('" + user_dep_no + "')";
                    }
                }
            }
            else
            ...
            DataTable dt = bus.GetReportData(JSSqlWhere, GZSqlWhere);
